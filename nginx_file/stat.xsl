...
<xsl:template match="/">
    <html>
        ...
        <body>
            ...
            <hr/>
	    <p>
            Nginx <a href="https://github.com/arut/nginx-rtmp-module">RTMP module</a> version <xsl:value-of select="/rtmp/nginx_rtmp_version"/>, 
            <a href="http://nginx.org/">Nginx</a> version<xsl:value-of select="/rtmp/nginx_version"/>,
